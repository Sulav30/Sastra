  ...
  return (
    <>
      <div className="bg-black text-white px-15 py-10 space-y-5 font-serif text-lg tracking-wide ">
        <p className="">
          Thank you for choosing Sastra ! We strive to provide you with a
        ...
        <div>
          ...
          <p>
            Delivery time within your location is typically 1-3 days from the
        ...
        <div>
          ...
          <p>
            For information on returns and refunds, please refer to our [Returns
            Policy].
          </p>
        </div>
        <div>
